                            ...
                            <div class="inline-block min-w-full py-2 align-middle">
                                <table class="w-full divide-y divide-gray-300">
                                    ...
                                    @foreach ($estudiantes as $estudiante)
										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $estudiante->user_id }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $estudiante->docente_id }}</td>
